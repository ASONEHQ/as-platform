...
/// `held-sales.types.ts`: `held` | `resumed` | `discarded`, never a
/// project-invented 4th state.
...
abstract interface class PosHeldSalesGateway {
  ...
  /// `GET /api/v1/held-sale-carts` — "Ventas suspendidas". This app always
  /// passes `status: 'held'` explicitly (the "what's currently paused"
  /// view), rather than relying on the backend's own default.
