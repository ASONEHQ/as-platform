...
| [INVENTORY_OPERATIONS_DESIGN.md](INVENTORY_OPERATIONS_DESIGN.md) | Transactional inventory operations design, physical model, posting, concurrency, transfers, reservations, and implementation plan |
